...
• **Visualize Cortex Capital trading agents** - Live P&L, trades, and agent activity

Instead of managing automation through dashboards and logs…

You walk through your AI workplace.

[Vision](VISION.md) · [Architecture](ARCHITECTURE.md) · [Contributing](CONTRIBUTING.md) · [Security](SECURITY.md) · [Cortex Capital Setup](CORTEX_SETUP.md)
