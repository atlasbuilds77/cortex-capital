...
import { DEFAULT_PREFERENCES, TIER_CONFIG } from '../lib/preferences';
import { buildPortfolio, type BuiltPortfolio } from '../lib/portfolio-builder';
import { analyzeStocks } from '../lib/stock-analyzer';
