...
export const BUMP_FREEZE_MS = 600;
export const BUMP_RECOVERY_MS = 400;
export const AGENT_RADIUS = 28;
export const SEPARATION_STRENGTH = 3;
export const AGENT_MAX_SPEED = 0.4;
export const AGENT_MAX_FORCE = 0.025;
export const STEERING_SEPARATION_DISTANCE = 50;
